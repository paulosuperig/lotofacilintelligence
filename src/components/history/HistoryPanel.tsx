      ...
      <div className="flex flex-col md:flex-row items-center md:items-center justify-between mb-8 md:mb-10 gap-4 text-center md:text-left">
        ...
        <div className="flex flex-wrap items-center justify-center gap-3">
          {history.length > 0 && (
            <>
              <Button 
                ...
                className="bg-[#25D366] hover:bg-[#128C7E] text-white rounded-xl shadow-md hover:shadow-[#25D366]/20 transition-all"
              >
          ...
          <Button 
            variant="outline" 
            onClick={onBack}
            className="rounded-xl border-purple-100 dark:border-zinc-700 text-purple-600 dark:text-purple-400 hover:bg-purple-50 dark:hover:bg-zinc-800"
          >
            Início
          </Button>
        </div>
            ...
            <div key={idx} className="p-6 bg-purple-50/50 dark:bg-zinc-800/50 border border-purple-100 dark:border-zinc-700 rounded-2xl flex flex-col gap-4">
              ...
              <div className="flex flex-wrap gap-2">
                {item.numbers.map((num: number, i: number) => (
                  <span key={i} className="w-8 h-8 rounded-lg bg-white dark:bg-zinc-800 border border-purple-100 dark:border-zinc-700 flex items-center justify-center text-xs font-bold text-purple-700 dark:text-purple-300 shadow-sm shrink-0">
