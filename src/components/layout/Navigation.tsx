...
export const MobileNav = ({ activeTab, setActiveTab, role, onLogout }: SidebarProps) => {
  return (
    <nav className="fixed bottom-0 left-0 right-0 h-[calc(4.5rem+env(safe-area-inset-bottom))] bg-white/90 dark:bg-zinc-900/90 backdrop-blur-2xl border-t border-purple-100 dark:border-zinc-800/50 z-[100] flex items-center justify-around px-6 pb-[env(safe-area-inset-bottom)] md:hidden">
