...
import { Zap, RefreshCcw, Save, TrendingUp, History, MessageCircle } from 'lucide-react';
...
export const GameGenerator = () => {
  ...
  const generateGame = () => {
    ...
    setTimeout(() => {
      ...
      setHistory(prev => [sortedNumbers, ...prev].slice(0, 10));
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="p-8 md:p-12 flex-grow flex flex-col">
        ...
        {history.length > 0 && (
          <div className="mt-12">
            <div className="flex items-center gap-2 text-premium-text-muted mb-6">
              <History size={16} />
              <h3 className="text-[10px] uppercase font-bold tracking-[0.2em]">Últimos 10 Jogos</h3>
            </div>
