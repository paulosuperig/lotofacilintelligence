...
import { Clover, Lock, User, Eye, EyeOff, LogIn } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-[#f5f3ff] flex items-center justify-center p-4 pt-[env(safe-area-inset-top)] pb-[env(safe-area-inset-bottom)]">
      <motion.div 
        ...
        className="w-full max-w-md bg-white rounded-[2.5rem] p-8 md:p-12 shadow-2xl shadow-purple-500/10 border border-purple-100"
      >
