...
export const TrendsCard = ({ onNavigate }: TrendsCardProps) => {
  ...
  return (
    <div
      ...
      className={`bg-white dark:bg-zinc-900 border border-purple-100 dark:border-zinc-800 rounded-3xl md:rounded-[2rem] p-5 sm:p-6 md:p-7 flex flex-col group overflow-hidden relative shadow-sm ${onNavigate ? 'cursor-pointer hover:border-purple-300 dark:hover:border-purple-600 transition-colors outline-none focus-visible:ring-2 focus-visible:ring-purple-500' : ''}`}
    >
