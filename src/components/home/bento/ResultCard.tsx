...
export const ResultCard = ({ latestResult, isLoading }: ResultCardProps) => (
  <div className="bg-white/50 dark:bg-zinc-900/50 border border-purple-100 dark:border-zinc-800 rounded-3xl md:rounded-[2rem] p-5 sm:p-6 md:p-8 relative group overflow-hidden shadow-sm hover:bg-white dark:hover:bg-zinc-900 transition-colors duration-500 flex flex-col">
